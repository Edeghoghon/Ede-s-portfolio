...
const Services = ({ isDarkMode, setIsDarkMode }) => {
  return (
    ...
    >
      ...
      >
        I am a frontend developer from Lagos, Nigeria,passionate about crafting
      ...
      >
        {serviceData.map(({ icon, title, description, link }, index) => (
          <motion.div
            ...
            key={index}
            className="border border-gray-400 rounded-lg px-8 py-12  hover: shadow-bg shadow-gray cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white"
          >
